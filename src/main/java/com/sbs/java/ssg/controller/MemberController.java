...
public class MemberController extends Controller {
	...
	public void doJoin() {
		...
		if (weight / (height * height / 10000) > 35) {
			bmi_level = "고도비만";
		...
		System.out.printf("운동난이 : ");
		String category_level = sc.nextLine();
		
		
		memberService.join(loginId, loginPw, nickName, sex, height, weight, bmi, bmi_level, loss ,months, category, category_level);

...
public class MemberService {
	...
	public void join(String loginId, String loginPw, String nickName, String sex, double height, double weight, double bmi, String bmi_level, String loss, String months, String category, String category_level) {
		Member member = new Member(loginId, loginPw, nickName, sex, height, weight, bmi, bmi_level, loss ,months, category, category_level);
